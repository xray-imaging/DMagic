...
# http://www.sphinx-doc.org/en/master/usage/extensions/autodoc.html#confval-autodoc_mock_imports
autodoc_mock_imports = "suds os datetime logging sys traceback ipdb collections numpy configparser unicodedata string validate_email subprocess pyinotify re urllib http xml argparse fnmatch ConfigParser request".split()
